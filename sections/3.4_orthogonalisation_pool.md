...
> **État : intégré** (session 7) — source : M124 (+ M031 pour le cadrage) ; relecture et vérification à venir. §3.4.5 vit dans son propre fichier (`3.4.5_combinaison_sous_couts.md`).
